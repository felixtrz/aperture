// Faithful port of references/Starter-Kit-Racing/js/Physics.js — computes the
// static wall colliders (straight/finish side walls + corner arc walls) and the
// ground box, as plain data the setup system spawns as fixed bodies.
