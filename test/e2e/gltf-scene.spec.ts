  ...
  expect(status, JSON.stringify(status, null, 2)).toMatchObject({
    ...
    readiness: {
      ibl: {
        ...
        phases: {
          ...
          appFrameRoute: expect.stringMatching(/^(ready|deferred)$/),
    ...
    ibl: {
      ...
      diffuseTextureResource: {
        ...
        textureSlotCount: 2,
        diffuseSlotCount: 1,
        createdTextureCount: expect.any(Number),
        reusedTextureCount: expect.any(Number),
        sections: {
          texturePreparation: true,
      ...
      samplerResources: {
        ...
        createdSamplerCount: expect.any(Number),
        reusedSamplerCount: expect.any(Number),
        sections: {
          samplerDescriptors: true,
          gpuAllocation: true,
          bindGroupLayout: false,
      ...
      resourceReuse: {
        diffuseTextureResourcesCreated: expect.any(Number),
        diffuseTextureResourcesReused: expect.any(Number),
        specularTextureResourcesCreated: expect.any(Number),
        specularTextureResourcesReused: expect.any(Number),
        samplerResourcesCreated: expect.any(Number),
        samplerResourcesReused: expect.any(Number),
      },
      cacheSummary: {
