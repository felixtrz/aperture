...
describe("WebGPU app depth texture resource", () => {
  it("reuses matching depth textures and recreates resized targets", () => {
    ...
    expect(events).toEqual([
      'create:{"label":"aperture/webgpu-app/depth","size":[640,360,1],"format":"depth24plus","usage":16}',
      "view:1",
      "destroy:1",
      'create:{"label":"aperture/webgpu-app/depth","size":[800,450,1],"format":"depth24plus","usage":16}',
      "view:2",
    ]);
  });
});
