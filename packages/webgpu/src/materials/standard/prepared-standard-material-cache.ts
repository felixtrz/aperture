...
import type {
  ...
  PreparedScalarStandardMaterialCache,
  PreparedScalarStandardMaterialDiagnostic,
  PreparedBaseColorTexturedStandardMaterialDiagnostic,
  PreparedMetallicRoughnessTexturedStandardMaterialDiagnostic,
  PreparedNormalTexturedStandardMaterialDiagnostic,
  PreparedClearcoatTexturedStandardMaterialDiagnostic,
  PreparedClearcoatRoughnessTexturedStandardMaterialDiagnostic,
  PreparedTransmissionTexturedStandardMaterialDiagnostic,
  PreparedSheenColorTexturedStandardMaterialDiagnostic,
  PreparedSheenRoughnessTexturedStandardMaterialDiagnostic,
  PreparedIridescenceTexturedStandardMaterialDiagnostic,
  PreparedIridescenceThicknessTexturedStandardMaterialDiagnostic,
  PreparedOcclusionEmissiveTexturedStandardMaterialDiagnostic,
  PrepareScalarStandardMaterialResourceOptions,
  PrepareScalarStandardMaterialResourceResult,
  PrepareBaseColorTexturedStandardMaterialResourceOptions,
  PrepareBaseColorTexturedStandardMaterialResourceResult,
  PrepareMetallicRoughnessTexturedStandardMaterialResourceOptions,
  PrepareMetallicRoughnessTexturedStandardMaterialResourceResult,
  PrepareNormalTexturedStandardMaterialResourceOptions,
  PrepareNormalTexturedStandardMaterialResourceResult,
  PrepareClearcoatTexturedStandardMaterialResourceOptions,
  PrepareClearcoatTexturedStandardMaterialResourceResult,
  PrepareClearcoatRoughnessTexturedStandardMaterialResourceOptions,
  PrepareClearcoatRoughnessTexturedStandardMaterialResourceResult,
  PrepareTransmissionTexturedStandardMaterialResourceOptions,
  PrepareTransmissionTexturedStandardMaterialResourceResult,
  PrepareSheenColorTexturedStandardMaterialResourceOptions,
  PrepareSheenColorTexturedStandardMaterialResourceResult,
  PrepareSheenRoughnessTexturedStandardMaterialResourceOptions,
  PrepareSheenRoughnessTexturedStandardMaterialResourceResult,
  PrepareIridescenceTexturedStandardMaterialResourceOptions,
  PrepareIridescenceTexturedStandardMaterialResourceResult,
  PrepareIridescenceThicknessTexturedStandardMaterialResourceOptions,
  PrepareIridescenceThicknessTexturedStandardMaterialResourceResult,
  PrepareOcclusionEmissiveTexturedStandardMaterialResourceOptions,
  PrepareOcclusionEmissiveTexturedStandardMaterialResourceResult,
} from "./prepared-standard-material-types.js";
