 ...
 * cascade the matrix was FIT for. Rather than a pure exponential split, we use a
 * linear/log average so the bounds stay byte-compatible with the already-shipped
 * selection bounds.
 */
