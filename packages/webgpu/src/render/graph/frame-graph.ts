...
// plus their descriptors live in a handle map keyed by stable id: a render
// target is identified by a stable handle id rather than by object identity, and
// history textures carry their previous-frame contents across frames via an
// explicit double-buffer kind.
//
