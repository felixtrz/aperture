...
import type { QueuedBuiltInAppResourceItem } from "../render/queues/queued-built-in-app-resource-set.js";
import type {
  QueuedBuiltInAppResourcePreparationCache,
...
export const QUEUED_BUILT_IN_MATERIAL_ADAPTERS =
  createQueuedBuiltInAppResourceAdapterRegistry<
...
export const QUEUED_BUILT_IN_APP_RESOURCE_ADAPTER_VALIDATION =
  queuedBuiltInAppResourceAdapterRegistryValidationReportToJsonValue(
    validateQueuedBuiltInAppResourceAdapterRegistry(
