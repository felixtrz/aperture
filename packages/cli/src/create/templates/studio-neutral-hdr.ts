/**
 * Generate Aperture's neutral, redistributable studio environment as a tiny
 * Radiance RGBE image. The broad key and rim gradients reveal surface shape
 * without photographic details, branding, or a network dependency.
 */
export function createStudioNeutralHdr(width = 32, height = 16): Uint8Array {
