...
export function writeParticleEmitterPacket(
  words: Uint32Array,
  offset: number,
  packet: ParticleEmitterPacket,
...
function particleSimulationSpaceId(
  value: ParticleSimulationSpacePacket,
): number {
  switch (value) {
    case "world":
      return 1;
...
function particleSimulationSpaceValue(
  id: number,
): ParticleSimulationSpacePacket {
  switch (id) {
    case 1:
...
function particleEmitterModeId(value: ParticleEmitterModePacket): number {
  switch (value) {
    case "continuous":
      return 1;
    case "burst":
...
function particleEmitterModeValue(
  id: number,
): ParticleEmitterModePacket | undefined {
  switch (id) {
    case 0:
      return undefined;
    case 1:
