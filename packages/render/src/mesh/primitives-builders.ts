...
export interface PrimitiveMeshAssetInput {
...
export type PrimitivePosition = readonly [number, number, number];
export type PrimitiveFace = readonly PrimitiveVertex[];
...
export function createPrimitiveMeshAsset(
  input: PrimitiveMeshAssetInput,
): MeshAsset {
  return {
    kind: "mesh",
    label: input.label,
...
export function interleavePrimitiveVertices(
...
export function interleavePrimitiveVertexList(
...
export function positiveFinite(
...
export function normalize(value: PrimitivePosition): PrimitivePosition {
