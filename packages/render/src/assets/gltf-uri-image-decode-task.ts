...
import {
  ...
  imageStatusUri,
  isRecord,
} from "./gltf-uri-image-sources.js";
import type {
...
export interface GltfExternalImageDecodeTaskResult {
  readonly decoded?: {
...
}): Promise<GltfExternalImageDecodeTaskResult | null> {
      ...
      diagnostics: [
        {
          ...
          message: errorMessage(
            error,
            `Decoding glTF image ${input.imageIndex} '${uri}' failed.`,
          ),
        },
      ],
      statuses: [
