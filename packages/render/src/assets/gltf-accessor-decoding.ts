...
import {
  accessorDecodingDiagnostic,
  gltfAccessorDecodingReportToJson,
  gltfAccessorDecodingReportToJsonValue,
} from "./gltf-accessor-decoding-report.js";
import {
  createDirectSourceBinding,
  decodeStridedAccessor,
  decodeTightlyPackedAccessor,
  sourceBytesView,
} from "./gltf-accessor-decoding-source.js";
import type {
...
export type * from "./gltf-accessor-decoding-types.js";
...
function decodeAccessor(
  ...
  if (sourceBytes === null) {
    diagnostics.push(
      accessorDecodingDiagnostic(primitive, accessor, {
