import type { GltfDecodedAccessor } from "./gltf-accessor-decoding-types.js";
import type { GltfDecodedPrimitiveAccessors } from "./gltf-accessor-decoding-types.js";
 ...
 * before.
 */
export function generateMissingNormals(
