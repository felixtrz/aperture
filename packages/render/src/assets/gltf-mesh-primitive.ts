...
import {
  allGltfMeshPrimitiveSelections,
  resolveGltfMeshPrimitiveReference,
} from "./gltf-mesh-primitive-selection.js";
import type {
...
export function createGltfMeshPrimitiveMappingReport(
  ...
  const selections =
    options.meshPrimitiveIndices ?? allGltfMeshPrimitiveSelections(meshes);
