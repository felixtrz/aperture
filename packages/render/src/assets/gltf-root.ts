export type GltfRootValidationDiagnosticSeverity = "error" | "warning";

export type GltfRootValidationDiagnosticCode =
  | "gltfRoot.malformedRoot"
  | "gltfRoot.invalidAsset"
  | "gltfRoot.unsupportedVersion"
  | "gltfRoot.malformedArray"
  | "gltfRoot.unsupportedRequiredExtension";

export type GltfRootDiagnosticValue = string | number | boolean | null;

export interface GltfRootValidationDiagnostic {
  readonly code: GltfRootValidationDiagnosticCode;
  readonly severity: GltfRootValidationDiagnosticSeverity;
  readonly message: string;
  readonly field?: string;
  readonly extensionName?: string;
  readonly value?: GltfRootDiagnosticValue;
}

export interface GltfRootValidationReport {
  readonly valid: boolean;
  readonly diagnostics: readonly GltfRootValidationDiagnostic[];
}

export type GltfRootValidationReportJsonValue = GltfRootValidationReport;
...
export function validateGltfRootForAssetMapping(
  ...
  const diagnostics: GltfRootValidationDiagnostic[] = [];
...
export function gltfRootValidationReportToJsonValue(
  report: GltfRootValidationReport,
...
export function gltfRootValidationReportToJson(
  report: GltfRootValidationReport,
): string {
...
function validateAsset(
  ...
  diagnostics: GltfRootValidationDiagnostic[],
): void {
...
function toDiagnosticValue(value: unknown): GltfRootDiagnosticValue {
  if (value === null) {
    return null;
  }
