import type { GltfDecodedImageData } from "../materials/index.js";
import {
...
import {
  chooseBasisKtx2TranscodeTarget,
  textureFormatFromDfdTransfer,
  textureLevelBytesPerRow,
  textureLevelRowsPerImage,
} from "./ktx2-basis-targets.js";
import type {
  BasisKtx2Encoding,
  BasisKtx2File,
  BasisModule,
