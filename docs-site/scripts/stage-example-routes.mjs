...
const browserImportTargets = {
  ...
  "@dimforge/rapier3d-compat":
    "packages/physics-rapier/node_modules/@dimforge/rapier3d-compat/rapier.mjs",
  "@preact/signals-core":
...
async function stagePackages() {
  ...
  await copyDependency("node_modules/elics", "node_modules/elics");
  await copyDependency("node_modules/wgpu-matrix", "node_modules/wgpu-matrix");
