...
export const CITY: CityConfig = {
  ...
  tiles: [
    ...
    { id: "building-garage", x: 2, z: -3, orientation: 0 },
    { id: "road-corner", x: 0, z: -2, orientation: 1 },
    { id: "road-straight-lightposts", x: 1, z: -2, orientation: 1 },
    { id: "road-split", x: 2, z: -2, orientation: 0 },
    { id: "road-straight", x: 3, z: -2, orientation: 3 },
    ...
    { id: "building-small-a", x: 3, z: -1, orientation: 0 },
    { id: "road-straight", x: -1, z: 0, orientation: 3 },
    ...
    { id: "building-small-d", x: -1, z: -2, orientation: 1 },
