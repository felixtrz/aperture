import { readEntity, readFloat64, readVec3, writeEntity, writeFloat64, writeVec3, } from "./snapshot-packed-codec-utils.js";
export function writeBoundsPacket(words, offset, packet) {
...
export function readBoundsPacket(words, offset) {
    return {
...
//# sourceMappingURL=snapshot-packed-bounds-codec.js.map