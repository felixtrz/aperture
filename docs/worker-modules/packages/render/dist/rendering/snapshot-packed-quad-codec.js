import { queueId, queueValue, readFloat64, readNullableHandle, readSigned32, writeFloat64, writeSigned32, } from "./snapshot-packed-codec-utils.js";
export function writeQuadBatchPacket(words, offset, packet, registry) {
...
export function readQuadBatchPacket(words, offset, registry) {
...
function quadBatchKindValue(id) {
    switch (id) {
        case 1:
            return "sprite";
        case 2:
...
function quadPipelineVariantId(variant) {
    switch (variant) {
        case "sprite":
            return 1;
        case "ui-panel":
...
function quadPipelineVariantValue(id) {
    switch (id) {
        case 1:
            return "sprite";
        case 2:
...
function quadCoordinateModeId(mode) {
    switch (mode) {
        case "world":
            return 1;
        case "screen":
...
function quadCoordinateModeValue(id) {
    switch (id) {
        case 1:
            return "world";
        case 2:
...
function quadBillboardModeId(mode) {
    switch (mode) {
        case "none":
            return 0;
        case "spherical":
...
function quadBillboardModeValue(id) {
    switch (id) {
        case 0:
            return "none";
        case 1:
...
function quadBlendModeValue(id) {
    switch (id) {
        case 1:
            return "opaque";
        case 2:
...
function quadDepthModeValue(id) {
    switch (id) {
        case 0:
        case 1:
            return "test";
...
//# sourceMappingURL=snapshot-packed-quad-codec.js.map