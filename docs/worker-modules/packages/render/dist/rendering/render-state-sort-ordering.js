export function compareStableRenderRecords(a, b) {
    const phaseOrder = stableRenderQueuePhaseRank(a.sortKey.queue) -
        stableRenderQueuePhaseRank(b.sortKey.queue);
    if (phaseOrder !== 0) {
        return phaseOrder;
    }
    const authorOrder = a.sortKey.viewId - b.sortKey.viewId ||
    ...
    if (a.sortKey.queue === "transparent" && b.sortKey.queue === "transparent") {
        return (compareDepth(a.sortKey, b.sortKey) ||
            a.sortKey.stableId - b.sortKey.stableId ||
            a.renderId - b.renderId);
    }
    return (a.sortKey.stableId - b.sortKey.stableId ||
        a.renderId - b.renderId ||
        compareDepth(a.sortKey, b.sortKey));
}
export function compareStateAwareRenderRecords(a, b) {
    const phaseOrder = renderQueuePhaseRank(a.sortKey.queue) -
    ...
    if (a.sortKey.queue === "transparent" && b.sortKey.queue === "transparent") {
        return (b.sortKey.depth - a.sortKey.depth ||
            a.sortKey.stableId - b.sortKey.stableId ||
    ...
    return (compareStrings(a.batchKey.pipelineKey, b.batchKey.pipelineKey) ||
        compareStrings(a.materialResourceKey, b.materialResourceKey) ||
        compareStrings(a.batchKey.meshLayoutKey, b.batchKey.meshLayoutKey) ||
        compareStrings(a.meshResourceKey, b.meshResourceKey) ||
...
function renderQueuePhaseRank(phase) {
    switch (phase) {
        case "opaque":
            return 0;
        case "alpha-test":
...
function stableRenderQueuePhaseRank(phase) {
...
//# sourceMappingURL=render-state-sort-ordering.js.map