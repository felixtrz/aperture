import { createPrimitiveMeshAsset, face, interleavePrimitiveVertices, } from "./primitives-builders.js";
export function createBoxMeshAsset(options = {}) {
...
export function createPlaneMeshAsset(options = {}) {
    const width = options.width ?? 1;
    const height = options.height ?? 1;
    const hx = width * 0.5;
    const hy = height * 0.5;
...
//# sourceMappingURL=primitives-box-plane.js.map