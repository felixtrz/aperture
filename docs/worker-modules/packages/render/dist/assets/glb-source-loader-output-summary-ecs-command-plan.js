export function createGlbSourceLoaderEcsCommandPlanSummaryJsonValue(plan) {
    if (plan === null) {
        return {
            status: "absent",
            valid: null,
    ...
    for (const command of plan.commands) {
        ...
        addComponentCount += 1;
        componentCountMap.set(command.component, (componentCountMap.get(command.component) ?? 0) + 1);
    }
    return {
        ...
        diagnosticsCount: plan.diagnostics.length +
            plan.skipped.reduce((total, entry) => total + entry.diagnostics.length, 0),
    };
}
const COMPONENT_COUNT_ORDER = [
    "Name",
    "LocalTransform",
    "Parent",
    "WorldTransform",
...
//# sourceMappingURL=glb-source-loader-output-summary-ecs-command-plan.js.map