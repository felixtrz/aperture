...
import { isRecord, mapOptionalIndex, nodeKey, toDiagnosticValue, validNodeReference, } from "./gltf-scene-traversal-utils.js";
export function traverseGltfSceneNode(input) {
    ...
    input.state.traversed.push({
        ...
        depth: input.depth,
        label: typeof rawNode.name === "string" && rawNode.name.length > 0
            ? rawNode.name
...
//# sourceMappingURL=gltf-scene-traversal-nodes.js.map