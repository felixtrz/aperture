export function isSupportedMeshAttributeArray(decoded) {
    if (decoded.semantic === "JOINTS_0") {
        return ((decoded.expectedFormat === "uint8x4" &&
...
export function decodedAttributeByteSize(decoded) {
    return decoded.itemSize * decodedComponentByteSize(decoded);
}
export function decodedComponentByteSize(decoded) {
...
export function meshVertexFormatByteSize(format) {
    switch (format) {
        case "uint8x4":
        case "unorm8x4":
            return 4;
...
export function meshVertexFormatForDecodedAccessor(decoded) {
    if (decoded.expectedFormat === "unorm8x4") {
        return "unorm8x4";
    }
    if (decoded.expectedFormat === "unorm16x4") {
...
//# sourceMappingURL=gltf-mesh-asset-vertex-formats.js.map