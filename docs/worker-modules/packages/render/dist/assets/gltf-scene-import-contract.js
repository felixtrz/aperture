...
export { gltfSceneImportContractReportToJson, gltfSceneImportContractReportToJsonValue, } from "./gltf-scene-import-contract-report.js";
export function createGltfSceneImportContractReport(options) {
    ...
    const primitiveMaterialResolution = options.sourceRegistrationReport === undefined
        ? null
        : createGltfPrimitiveMaterialResolutionReport({
            ...
            ...(options.availableMaterialHandleKeys === undefined
                ? {}
                : {
                    availableMaterialHandleKeys: options.availableMaterialHandleKeys,
                }),
    ...
    const ecsCommandPlan = primitiveMaterialResolution === null ||
...
//# sourceMappingURL=gltf-scene-import-contract.js.map