...
import { imageDecodeCacheKey, imageDecodeOptionsKeyField, resolveBasisKtx2Transcoder, } from "./gltf-uri-image-cache.js";
import { byteLengthOf, bytesForImageSource, externalImageSourceKind, imageSourceRefFromImage, imageStatusUri, isRecord, } from "./gltf-uri-image-sources.js";
import { errorMessage } from "./gltf-uri-shared.js";
export async function decodeGltfExternalImage(input) {
            ...
            diagnostics: [
                {
                    ...
                    imageIndex: input.imageIndex,
                    uri,
                    message: errorMessage(error, `Decoding glTF image ${input.imageIndex} '${uri}' failed.`),
                },
            ],
            statuses: [
                {
                    ...
                    ...(source.source.mimeType === undefined
                        ? {}
                        : { mimeType: source.source.mimeType }),
                    diagnosticCode: "loadGltfFromUri.imageReadFailed",
                },
            ],
        };
    }
}
//# sourceMappingURL=gltf-uri-image-decode-task.js.map