import { createGltfTextureMappingReport as result, preparedReport, } from "./gltf-texture-result.js";
import { createMappedSampler, mapSamplerIndex, } from "./gltf-texture-sampler-mapping.js";
import { inspectTextureExtensions, mapImageIndex, mapImageSource, } from "./gltf-texture-source-mapping.js";
import { isNonNegativeInteger, isRecord, toDiagnosticValue, } from "./gltf-texture-utils.js";
export function prepareGltfTextureMapping(options) {
    const diagnostics = [];
    ...
    if (!isNonNegativeInteger(textureIndex)) {
        ...
        return preparedReport(result({ options, diagnostics, texture: null, sampler: null }));
    }
...
//# sourceMappingURL=gltf-texture-prepare.js.map