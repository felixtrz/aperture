...
export async function decodeImageUrlToTextureSource(url, options = {}) {
    const source = {
        kind: "uri",
        uri: url,
...
async function fetchImageBytes(url, options) {
    ...
    if (!response.ok) {
        throw new Error(`Image '${url}' failed to load with HTTP ${response.status}.`);
    }
...
async function bytesFromFetchResult(result) {
...
//# sourceMappingURL=image-texture-decode.js.map