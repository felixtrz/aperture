import { createStandardMaterialAsset, createUnlitMaterialAsset, } from "./factories.js";
import { inspectUnsupportedClearcoatTextures, inspectUnsupportedUnlitFields, } from "./gltf-material-extensions.js";
...
import { mapStandardClearcoatFields, mapStandardIridescenceFields, mapStandardSheenFields, mapStandardTransmissionFields, mapStandardVolumeFields, } from "./gltf-material-standard-extension-fields.js";
import { mapStandardPbrFields, mapStandardSurfaceFields, } from "./gltf-material-standard-fields.js";
...
export function createUnlitGltfMaterialAsset(input) {
    ...
    inspectUnsupportedUnlitFields(input.material, input.pbrSource, input.materialKey, input.diagnostics);
    return mapped;
}
export function createStandardGltfMaterialAsset(input) {
    const mapped = createStandardMaterialAsset({
        label: input.label,
        renderState: withTransmissionRenderState(input.renderState, input.transmissionFactor),
    ...
    inspectUnsupportedClearcoatTextures(input.clearcoatSource, input.materialKey, input.diagnostics);
    return mapped;
}
//# sourceMappingURL=gltf-material-builders.js.map