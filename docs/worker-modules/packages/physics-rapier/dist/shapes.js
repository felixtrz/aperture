...
export function queryShape(shape) {
    switch (shape.kind) {
        case "box":
        ...
        case "trimesh":
        case "heightfield":
            throw new Error(`Rapier backend does not support '${shape.kind}' overlap queries in this slice.`);
    }
}
export function colliderShapeRotation(collider) {
...
export function queryShapeRotation(rotation, shape) {
...
function primitiveAxisRotation(shape) {
    switch (shape.kind) {
        case "capsule":
        case "cylinder":
        case "cone":
