import { vec3 as wgpuVec3 } from "/aperture/worker-modules/node_modules/wgpu-matrix/dist/3.x/wgpu-matrix.module.js";
...
export function intersectRaySphere(ray, sphere, maxDistance = Number.POSITIVE_INFINITY) {
    const offset = wgpuVec3.subtract(asWgpuVec3Arg(ray.origin), asWgpuVec3Arg(sphere.center));
...
function rayHitAt(ray, distance) {
    return {
        distance,
        point: wgpuVec3.addScaled(asWgpuVec3Arg(ray.origin), asWgpuVec3Arg(ray.direction), distance, vec3()),
    };
}
