...
export function standardTextureVariantBindings(features) {
    ...
    if (features.pointShadowMap === true) {
        ...
        bindings.push({
            ...
            id: "directionalShadowMap",
            label: features.clusteredLocalLightPointArrayShadows === true
...
//# sourceMappingURL=standard-shader-variant-bindings.js.map