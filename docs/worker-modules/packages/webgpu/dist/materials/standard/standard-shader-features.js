...
export const STANDARD_DIRECT_LIGHT_SHADER_VARIANT = "direct-lit-metallic-roughness";
export const STANDARD_BASE_COLOR_TEXTURE_SHADER_VARIANT = "direct-lit-metallic-roughness-base-color-texture";
export const STANDARD_METALLIC_ROUGHNESS_TEXTURE_SHADER_VARIANT = "direct-lit-metallic-roughness-texture";
export const STANDARD_BASE_COLOR_METALLIC_ROUGHNESS_TEXTURE_SHADER_VARIANT = "direct-lit-metallic-roughness-base-color-metallic-roughness-texture";
export const STANDARD_SHADOW_MAP_SHADER_VARIANT = "direct-lit-metallic-roughness-shadow-map";
export const STANDARD_CASCADED_SHADOW_MAP_SHADER_VARIANT = "direct-lit-metallic-roughness-cascaded-shadow-map";
export const STANDARD_POINT_SHADOW_MAP_SHADER_VARIANT = "direct-lit-metallic-roughness-point-shadow-map";
export const STANDARD_MULTI_SHADOW_MAP_SHADER_VARIANT = "direct-lit-metallic-roughness-multi-shadow-map";
export const STANDARD_DIFFUSE_IBL_SHADER_VARIANT = "direct-lit-metallic-roughness-diffuse-ibl";
export const STANDARD_SPECULAR_IBL_PROOF_SHADER_VARIANT = "direct-lit-metallic-roughness-diffuse-specular-ibl-proof";
const STANDARD_SPECULAR_IBL_BRDF_SHADER_VARIANT = "direct-lit-metallic-roughness-diffuse-specular-ibl-brdf";
export const STANDARD_CLEARCOAT_SHADER_VARIANT = "direct-lit-metallic-roughness-clearcoat";
export const STANDARD_TRANSMISSION_SHADER_VARIANT = "direct-lit-metallic-roughness-transmission";
export const STANDARD_SHEEN_SHADER_VARIANT = "direct-lit-metallic-roughness-sheen";
export const STANDARD_IRIDESCENCE_SHADER_VARIANT = "direct-lit-metallic-roughness-iridescence";
...
export function createStandardTextureShaderVariantKey(features) {
...
export function standardTextureFeatureNames(features) {
    const names = [];
    if (features.baseColorTexture) {
        names.push("base-color");
    }
...
function appendStandardFogFeatureName(names, features) {
...
export function hasStandardFogFeature(features) {
    return (features.fogLinear === true ||
        features.fogExp === true ||
        features.fogExp2 === true);
}
export function hasStandardGenericOnlyFeature(features) {
    return (features.clearcoat === true ||
        features.transmission === true ||
        features.transmissionTexture === true ||
        features.sheenColorTexture === true ||
        features.sheenRoughnessTexture === true ||
...
export function hasAnyStandardTextureFeature(features) {
    return (features.baseColorTexture ||
        features.metallicRoughnessTexture ||
        features.clearcoatTexture === true ||
        features.clearcoatRoughnessTexture === true ||
        features.transmissionTexture === true ||
...
//# sourceMappingURL=standard-shader-features.js.map