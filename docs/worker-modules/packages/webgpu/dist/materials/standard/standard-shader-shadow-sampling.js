...
export function applyStandardShadowMapSampling(code, options = {}) {
    const helpers = options.cascaded === true
...
fn evaluateDirectLight(
  normal: vec3f,`)
    ...
    return directionalApplied.replace(`        direct = direct + evaluateDirectLight(
          normal,
          viewDir,
          lightDir,
...
function pointShadowReceiverSamplingBody(pointArrayShadows) {
...
export function applyStandardPointShadowMapSampling(code, options = {}) {
    return code
        .replace(`fn evaluateDirectLight(
  normal: vec3f,`, `${SHADOW_DEPTH_FROM_CLIP_WGSL}
...
export function applyStandardMultiShadowMapSampling(code, options = {}) {
    let result = code
        .replace(`fn evaluateDirectLight(
  normal: vec3f,`, `${SHADOW_DEPTH_FROM_CLIP_WGSL}
...
//# sourceMappingURL=standard-shader-shadow-sampling.js.map