...
`.trim();
export const DEBUG_NORMAL_MESH_SHADER = {
...
export function createDebugNormalMeshShaderModuleDescriptor(shader = DEBUG_NORMAL_MESH_SHADER) {
    return {
        label: shader.label,
        code: shader.code,
...
export function validateDebugNormalShaderMetadata(shader) {
    const diagnostics = [];
...
//# sourceMappingURL=debug-normal-shader.js.map