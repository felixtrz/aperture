...
`.trim();
export async function createProceduralSkyRenderPipelineResource(options) {
        ...
        return {
            ...
            diagnostics: [
                ...shaderDiagnostics,
                {
                    ...
                    message: "WebGPU device cannot create procedural sky render pipelines.",
                },
            ],
        };
    }
    ...
    try {
        return {
            valid: true,
            resource: {
                cacheKey: proceduralSkyPipelineCacheKey(options.colorFormat, options.depthFormat ?? null, options.sampleCount ?? 1),
                shaderModule: shaderModule.module,
...
export function proceduralSkyPipelineCacheKey(colorFormat, depthFormat, sampleCount = 1) {
...
//# sourceMappingURL=procedural-sky-pipeline.js.map