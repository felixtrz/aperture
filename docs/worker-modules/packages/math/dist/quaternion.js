import { quat as kquat, vec3 as kvec3, } from "./kernel/index.js";
...
export function quatFromAxisAngle(axis, radians, out = quat()) {
    ...
    return kquat.fromAxisAngle([v3(axis, 0) * inv, v3(axis, 1) * inv, v3(axis, 2) * inv], radians, out);
}
...
export function rotateVec3ByQuat(value, rotation, out = kvec3.create()) {
...
function toKernelRotationOrder(order) {
