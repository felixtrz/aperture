import { transformPoint } from "/aperture/worker-modules/packages/simulation/dist/index.js";
 ...
 * fallback today).
 */
export function closestPointOnMeshes(meshes, point, options) {
    ...
    for (const entry of meshes) {
        ...
        const localPoint = transforms.meshFromWorld === undefined
            ? point
