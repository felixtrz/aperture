import { createPhysicsWorldSyncState, stepPhysicsWorld, } from "/aperture/worker-modules/packages/physics/dist/index.js";
...
async function createConfiguredPhysicsBackend(config, options) {
    ...
    if (backend === "rapier") {
        const { createRapierPhysicsBackend } = await import("/aperture/worker-modules/packages/physics-rapier/dist/index.js");
