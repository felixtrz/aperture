...
function startWorkerSnapshotLoop(aperture, app, scene, readbackUsage) {
  const worker = new Worker(
    "/aperture/worker-modules/examples/render-to-texture.worker.js",
    {
    ...
    label: routeConfig.mixedCroppedSecondaryRenderTargets
      ...
      : routeConfig.mixedMsaaCroppedSecondaryRenderTargets
        ...
        : routeConfig.mixedMsaaMultiRenderTargets
          ...
          : isMixedMsaaResizedReusedDualSizeRoute()
            ? "render-to-texture/mixed-msaa-resized-reused-dual-size-targets"
                ...
                : isMixedMsaaDualSizeRoute()
                  ...
                  : routeConfig.mixedDualSizeRenderTargets
                    ...
                    : isMixedMsaaResizedClearLoadRoute()
                      ...
                      : isMixedMsaaReusedClearLoadRoute()
                        ? "render-to-texture/mixed-msaa-reused-clear-load-target"
                        : routeConfig.mixedMsaaClearLoadTarget
...
function isMixedMsaaResizedReusedDualSizeRoute() {
  return (
    routeConfig.mixedDualSizeRenderTargets &&
    routeConfig.resizeTarget &&
    routeConfig.reuseStress &&
...
function isMixedMsaaReusedClearLoadRoute() {
  return (
    routeConfig.mixedMsaaClearLoadTarget &&
    routeConfig.reuseStress &&
    routeConfig.targetMsaa &&
    ...
    ...(isMixedMsaaReusedClearLoadRoute()
      ? {
          mixedMsaaReusedSameTargetClearLoad:
            createMixedMsaaReusedSameTargetClearLoadStatus(
              aperture,
              scene,
              message,
              offscreenReport,
    ...
    ...(isMixedMsaaResizedReusedDualSizeRoute()
      ? {
          mixedMsaaResizedReusedDualSizeRenderTargets:
            createMixedMsaaResizedReusedDualSizeRenderTargetsStatus(
              aperture,
              scene,
              message,
              offscreenReport,
...
function routeConfigForPath(pathname) {
  ...
  if (pathname.endsWith("/mixed-msaa-resized-reuse-dual-size.html")) {
    return {
  ...
  if (pathname.endsWith("/mixed-msaa-reuse-clear-load.html")) {
    return {
...
function createMixedMsaaResizedReusedDualSizeRenderTargetsStatus(
  aperture,
  scene,
  message,
  offscreenReport,
...
function createMixedMsaaReusedSameTargetClearLoadStatus(
  aperture,
  scene,
  message,
  offscreenReport,
