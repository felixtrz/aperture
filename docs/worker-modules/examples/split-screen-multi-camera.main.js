...
function routeConfigForPath(pathname) {
  if (pathname.endsWith("/line-primitives.html")) {
    return {
      ...
      workerUrl: "/aperture/worker-modules/examples/line-primitives.worker.js",
  ...
  if (pathname.endsWith("/orthographic-camera.html")) {
    return {
      ...
      workerUrl: "/aperture/worker-modules/examples/orthographic-camera.worker.js",
  ...
  if (pathname.endsWith("/camera-render-layers.html")) {
    return {
      ...
      workerUrl: "/aperture/worker-modules/examples/camera-render-layers.worker.js",
  ...
  if (pathname.endsWith("/camera-priority-overlay.html")) {
    return {
      ...
      workerUrl: "/aperture/worker-modules/examples/camera-priority-overlay.worker.js",
  ...
  if (pathname.endsWith("/camera-sub-view-crop.html")) {
    return {
      ...
      workerUrl: "/aperture/worker-modules/examples/camera-sub-view-crop.worker.js",
  ...
  if (pathname.endsWith("/camera-viewport-grid.html")) {
    return {
      ...
      workerUrl: "/aperture/worker-modules/examples/camera-viewport-grid.worker.js",
  ...
  if (pathname.endsWith("/camera-clear-load-matrix.html")) {
    return {
      ...
      workerUrl: "/aperture/worker-modules/examples/camera-clear-load-matrix.worker.js",
  ...
  if (pathname.endsWith("/camera-picture-in-picture.html")) {
    return {
      ...
      workerUrl: "/aperture/worker-modules/examples/camera-picture-in-picture.worker.js",
  ...
  if (pathname.endsWith("/camera-viewport-resize.html")) {
    return {
      ...
      workerUrl: "/aperture/worker-modules/examples/camera-viewport-resize.worker.js",
  ...
  return {
    ...
    workerUrl: "/aperture/worker-modules/examples/split-screen-multi-camera.worker.js",
