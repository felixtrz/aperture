...
} from "/aperture/worker-modules/packages/app/dist/browser.js";
...
try {
  await startGeneratedBrowserApp({
    ...
    workerEntry: "/aperture/worker-modules/examples/particle-bursts.worker.js",
    systemManifest: [
      {
        moduleUrl: "/aperture/examples/particle-bursts.worker.js",
