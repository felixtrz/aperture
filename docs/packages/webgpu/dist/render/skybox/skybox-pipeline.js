...
`.trim();
export async function createSkyboxRenderPipelineResource(options) {
    ...
    try {
        return {
            valid: true,
            resource: {
                cacheKey: skyboxPipelineCacheKey(options.colorFormat, options.depthFormat ?? null, options.sampleCount ?? 1),
                shaderModule: shaderModule.module,
...
export function skyboxPipelineCacheKey(colorFormat, depthFormat, sampleCount = 1) {
...
//# sourceMappingURL=skybox-pipeline.js.map