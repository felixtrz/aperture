import { hasStandardFogFeature, hasStandardGenericOnlyFeature, standardTextureFeatureNames, } from "./standard-shader-features.js";
export function standardTextureVariantShaderLabel(features) {
    ...
    return `aperture/standard-mesh-${standardTextureFeatureNames(features).join("-")}-textured`;
}
//# sourceMappingURL=standard-shader-variant-label.js.map