...
`.trim();
export const UNLIT_MESH_SHADER = {
...
export const UNLIT_VERTEX_COLOR_MESH_SHADER = {
...
export const UNLIT_TEXTURED_MESH_SHADER = {
...
export const UNLIT_TEXTURED_VERTEX_COLOR_MESH_SHADER = {
...
export const UNLIT_MESH_WITH_LIGHT_BINDINGS_SHADER = {
...
export function createUnlitMeshShaderModuleDescriptor(shader = UNLIT_MESH_SHADER) {
    return {
        label: shader.label,
        code: shader.code,
...
export function validateBuiltInShaderMetadata(shader) {
    const diagnostics = [];
