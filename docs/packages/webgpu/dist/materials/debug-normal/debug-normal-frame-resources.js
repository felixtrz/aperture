...
export function createDebugNormalFrameGpuResources(options) {
    const diagnostics = [];
...
function createViewUniformResource(options, diagnostics) {
    ...
    if (options.viewUniforms === null) {
        diagnostics.push({
            ...
            message: "DebugNormal frame GPU resource creation requires packed view uniforms.",
        });
        return null;
    }
...
function createWorldTransformResource(options, diagnostics) {
    ...
    if (options.worldTransforms === null) {
        diagnostics.push({
            ...
            message: "DebugNormal frame GPU resource creation requires packed world transforms.",
        });
        return null;
    }
...
function createMaterialResource(options, diagnostics) {
    if (options.material === null) {
        diagnostics.push({
            ...
            message: "DebugNormal frame GPU resource creation requires a debug-normal material asset.",
        });
        return null;
    }
...
function createSharedBindGroupDescriptorPlan(input) {
    ...
    if (input.viewUniformResourceKey === null) {
        diagnostics.push({
            ...
            message: "DebugNormal shared bind group planning requires a view uniform.",
        });
    }
    else {
        entries.push({
    ...
    if (input.worldTransformResourceKey === null) {
        diagnostics.push({
            ...
            message: "DebugNormal shared bind group planning requires a world transform buffer.",
        });
    }
    else {
        entries.push({
    ...
    if (input.previousWorldTransformResourceKey !== undefined) {
        if (input.previousWorldTransformResourceKey === null) {
            diagnostics.push({
                code: "unlitBindGroup.missingTransformResource",
                message: "DebugNormal motion-vector shared bind group planning requires a previous world transform buffer.",
            });
        }
        else {
            entries.push({
...
//# sourceMappingURL=debug-normal-frame-resources.js.map