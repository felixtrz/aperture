...
`.trim();
export const MATCAP_MESH_SHADER = {
...
export function createMatcapMeshShaderModuleDescriptor(shader = MATCAP_MESH_SHADER) {
    return {
        label: shader.label,
        code: shader.code,
...
export function validateMatcapShaderMetadata(shader) {
    const diagnostics = [];
...
//# sourceMappingURL=matcap-shader.js.map