export function createWebGpuFxaaPostEffect(options = {}) {
    ...
    return {
        ...
        prepare(prepareOptions) {
            ...
            return preparedFxaaPass(id, label, [
                {
                    kind: "setPipeline",
                    renderId: 0,
                    pipelineKey,
...
function preparedFxaaPass(effectId, label, commands, diagnostics) {
    return {
        effectId,
        label,
        commands,
...
`;
//# sourceMappingURL=post-fxaa.js.map