...
export function createWebGpuSsrPostEffect(options = {}) {
    ...
    const reflectionBlurPixels = clampFinite(options.reflectionBlurPixels ?? 1.25, 0, 8);
    ...
    return {
        ...
        prepare(prepareOptions) {
            ...
            return preparedSsrPass(id, label, [
                {
                    kind: "setPipeline",
                    renderId: 0,
                    pipelineKey,
...
function preparedSsrPass(effectId, label, commands, diagnostics) {
    return {
        effectId,
        label,
        commands,
...
//# sourceMappingURL=post-ssr.js.map