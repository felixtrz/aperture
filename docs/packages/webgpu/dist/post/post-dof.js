...
export function createWebGpuDofPostEffect(options = {}) {
    ...
    const sampleOffsets = createConcentricDofSampleOffsets(blurRings, blurRingPoints);
    ...
    return {
        ...
        prepare(prepareOptions) {
            ...
            return preparedDofPass(id, label, [
                {
                    kind: "setPipeline",
                    renderId: 0,
                    pipelineKey,
...
function preparedDofPass(effectId, label, commands, diagnostics) {
    return {
        effectId,
        label,
        commands,
...
function createConcentricDofSampleOffsets(blurRings, blurRingPoints) {
    const offsets = [];
...
function dofSampleAccumulationWgsl(sampleOffsets) {
...
//# sourceMappingURL=post-dof.js.map