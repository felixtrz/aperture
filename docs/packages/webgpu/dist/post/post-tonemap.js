...
import { createOutputTonemapWgsl, } from "../output/output-stage-tonemap.js";
import { createOutputColorSpaceWgsl, } from "../output/output-stage-color-space.js";
export function createWebGpuTonemapPostEffect(options) {
    ...
    return {
        ...
        prepare(prepareOptions) {
            ...
            return preparedTonemapPass(id, label, [
                {
                    kind: "setPipeline",
                    renderId: 0,
                    pipelineKey,
...
function preparedTonemapPass(effectId, label, commands, diagnostics) {
    return { effectId, label, commands, diagnostics };
}
export function tonemapPostEffectWgsl(operator, outputColorSpace, exposure) {
...
function formatExposureLiteral(exposure) {
...
//# sourceMappingURL=post-tonemap.js.map