...
export function copy(srcIn, dst) {
    const src = srcIn;
    const d = allocMat4(dst);
    d[0] = src[0];
    d[1] = src[1];
...
export function multiply(aIn, bIn, dst) {
    const a = aIn;
    const b = bIn;
    const d = allocMat4(dst);
    const a00 = a[0];
 ...
 */
export function mulAffine(aIn, bIn, dst) {
    const a = aIn;
    const b = bIn;
    const d = allocMat4(dst);
    const a00 = a[0];
...
export function determinant(mIn) {
    const m = mIn;
    const m00 = m[0];
    const m01 = m[1];
    const m02 = m[2];
 ...
 */
export function inverse(mIn, dst) {
    const m = mIn;
    const d = allocMat4(dst);
    const a00 = m[0];
    const a01 = m[1];
 ...
 */
export function invertAffine(mIn, dst) {
    const m = mIn;
    const a00 = m[0];
    const a01 = m[1];
    const a02 = m[2];
...
export function fromQuat(qIn, dst) {
    const q = qIn;
    const d = allocMat4(dst);
    const x = q[0];
    const y = q[1];
...
export function scale(mIn, vIn, dst) {
    const m = mIn;
    const v = vIn;
    const d = allocMat4(dst);
    const v0 = v[0];
...
export function setTranslation(mIn, vIn, dst) {
    const m = mIn;
    const v = vIn;
    const d = allocMat4(dst);
    if (mIn !== d) {
...
export function getTranslation(mIn, dst) {
    const m = mIn;
 ...
 */
export function composeTRS(tIn, qIn, sIn, dst) {
    const t = tIn;
    const q = qIn;
    const s = sIn;
    const d = allocMat4(dst);
 ...
 */
export function perspective(fovyRadians, aspect, zNear, zFar, dst) {
    const d = allocMat4(dst);
