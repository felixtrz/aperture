...
import { AudioDistanceModel, AudioPanningModel, AudioSimulationSpace, FogMode, ParticleSimulationSpace, ProceduralSkyModel, SpriteBillboardMode, SpriteBlendMode, SpriteCoordinateMode, SpriteDepthMode, SpriteSizeMode, UiLayoutMode, UiScreenScaleMode, UiTextAlign, } from "./authoring-types.js";
import { tuple2, tuple3, tuple4 } from "./authoring-utils.js";
export const Mesh = defineComponent("aperture.render.mesh", {
    meshId: { type: EcsType.String, default: "" },
}, "Renderer-independent mesh authoring component that stores a mesh asset handle id only.");
export const Material = defineComponent("aperture.render.material", {
...
export const MaterialSlots = defineComponent("aperture.render.materialSlots", {
    slotsJson: { type: EcsType.String, default: "[]" },
}, "Renderer-independent material slot overrides for multi-submesh mesh draws.");
export const Sprite = defineComponent("aperture.render.sprite", {
    ...
    depthMode: {
        type: EcsType.Enum,
        enum: SpriteDepthMode,
        default: SpriteDepthMode.Test,
    },
}, "Renderer-independent sprite authoring component for camera-facing billboard quads.");
export const ParticleEmitter = defineComponent("aperture.render.particleEmitter", {
...
export const AudioEmitter = defineComponent("aperture.render.audioEmitter", {
...
export const AudioListener = defineComponent("aperture.render.audioListener", {
    active: { type: EcsType.Boolean, default: true },
...
export const UiScreen = defineComponent("aperture.render.ui.screen", {
...
export const UiNode = defineComponent("aperture.render.ui.node", {
...
export const UiHitTarget = defineComponent("aperture.render.ui.hitTarget", {
...
export const UiScroll = defineComponent("aperture.render.ui.scroll", {
    enabled: { type: EcsType.Boolean, default: true },
...
export const Skybox = defineComponent("aperture.render.skybox", {
    textureId: { type: EcsType.String, default: "" },
    samplerId: { type: EcsType.String, default: "" },
...
export const ProceduralSky = defineComponent("aperture.render.proceduralSky", {
    model: {
        type: EcsType.Enum,
...
export const RuntimeUniform = defineComponent("aperture.render.runtimeUniform", {
...
export const Fog = defineComponent("aperture.render.fog", {
    mode: {
        type: EcsType.Enum,
        enum: FogMode,
...
export const Visibility = defineComponent("aperture.render.visibility", {
    visible: { type: EcsType.Boolean, default: true },
}, "Authoring visibility flag consumed by render extraction.");
export const OcclusionQuery = defineComponent("aperture.render.occlusionQuery", {
    enabled: { type: EcsType.Boolean, default: true },
}, "Opt-in renderer-owned GPU occlusion-query feedback for mesh draws.");
export const RenderLayer = defineComponent("aperture.render.layer", {
    mask: { type: EcsType.Int32, default: 1 },
}, "Render layer mask used for camera and light filtering.");
export const RenderOrder = defineComponent("aperture.render.order", {
    value: { type: EcsType.Int32, default: 0 },
}, "Stable authoring order hint consumed by render sorting.");
export const InstanceTint = defineComponent("aperture.render.instanceTint", {
    color: { type: EcsType.Color, default: tuple4(1, 1, 1, 1) },
}, "Per-entity tint packed for instanced StandardMaterial draws.");
export const InstanceData = defineComponent("aperture.render.instanceData", {
...
export const Skin = defineComponent("aperture.render.skin", {
...
export const MorphTargetWeights = defineComponent("aperture.render.morphTargetWeights", {
...
//# sourceMappingURL=authoring-components-core.js.map