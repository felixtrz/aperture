import { AudioEmitter, AudioListener, Camera, Fog, InstanceData, InstanceTint, Light, LightCookie, LightShadowSettings, Material, MaterialSlots, Mesh, MeshQueryAcceleration, MorphTargetWeights, OcclusionQuery, ParticleEmitter, Pickable, ProceduralSky, RenderLayer, RenderOrder, RuntimeUniform, ShadowCaster, ShadowReceiver, Skin, Skybox, Sprite, UiHitTarget, UiImage, UiNode, UiPanel, UiScreen, UiScroll, UiText, Visibility, } from "./authoring-components.js";
...
export function registerRenderAuthoringComponents(world) {
