import { createPackedSnapshotInstanceAttributesScratch, ensureInstanceAttributeDataCapacity, instanceAttributeOffsetAt, } from "./transform-pack-scratch.js";
import { findInstanceAttributeField, findTransformPackedOffset, hasInstanceAttributeValues, } from "./transform-pack-guards.js";
export { packSnapshotInstanceTints, packSnapshotInstanceTintsForVertexBuffer, writePackedSnapshotInstanceTintsForVertexBuffer, } from "./transform-pack-instance-tints.js";
export function packSnapshotInstanceAttributesForVertexBuffer(snapshot, transforms, layout, options = {}) {
    return writePackedSnapshotInstanceAttributesForVertexBuffer(snapshot, transforms, layout, createPackedSnapshotInstanceAttributesScratch(), options);
}
export function writePackedSnapshotInstanceAttributesForVertexBuffer(snapshot, transforms, layout, scratch, options = {}) {
    ...
    for (const draw of snapshot.meshDraws) {
        ...
        for (const attribute of layout.attributes) {
            ...
            scratch.data.set(source.subarray(field.offset, field.offset + field.components), packedOffset + attribute.floatOffset);
        }
...
//# sourceMappingURL=transform-pack-instances.js.map