import { DEFAULT_PACKED_AREA_LIGHT_SHAPE_ID, areaLightShapeId, areaLightShapeValue, lightKindId, lightKindValue, readEntity, readFloat32, readFloat64, readNullableHandle, readVec4, writeEntity, writeFloat32, writeFloat64, writeVec4, } from "./snapshot-packed-codec-utils.js";
export function writeLightPacket(words, offset, packet, registry) {
...
export function readLightPacket(words, offset, registry) {
    ...
    const packet = {
        ...
        shape: areaLightShapeValue(words[offset + 24] ?? DEFAULT_PACKED_AREA_LIGHT_SHAPE_ID),
...
export function writeEnvironmentPacket(words, offset, packet, registry) {
...
export function readEnvironmentPacket(words, offset, registry) {
    return {
...
export function writeShadowRequestPacket(words, offset, packet) {
...
export function readShadowRequestPacket(words, offset) {
...
//# sourceMappingURL=snapshot-packed-light-codec.js.map