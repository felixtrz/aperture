import { createStandardGltfMaterialAsset, createUnlitGltfMaterialAsset, } from "./gltf-material-builders.js";
import { CLEARCOAT_EXTENSION, IRIDESCENCE_EXTENSION, IOR_EXTENSION, SHEEN_EXTENSION, TRANSMISSION_EXTENSION, VOLUME_EXTENSION, inspectMaterialExtensions, } from "./gltf-material-extensions.js";
...
export { gltfMaterialMappingReportToJson, gltfMaterialMappingReportToJsonValue, } from "./gltf-material-report.js";
export function createMaterialAssetFromGltfMaterial(material, options = {}) {
    const diagnostics = [];
    ...
    const pbrSource = optionalRecordField({
        source: material,
    ...
    const unlit = isRecord(materialExtensions)
        ...
        : false;
    const clearcoatSource = isRecord(materialExtensions) &&
        ...
        : undefined;
    const transmissionSource = isRecord(materialExtensions) &&
        ...
        : undefined;
    const sheenSource = isRecord(materialExtensions) &&
        ...
        : undefined;
    const iridescenceSource = isRecord(materialExtensions) &&
        ...
        : undefined;
    const iorSource = isRecord(materialExtensions) &&
        ...
        : undefined;
    const volumeSource = isRecord(materialExtensions) &&
...
function materialLabel(material, materialKey) {
