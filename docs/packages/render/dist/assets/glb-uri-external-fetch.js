...
import { isRecord, resolveSameOriginBufferUrl, resolveSameOriginImageUrl, } from "./glb-uri-external-fetch-resolve.js";
...
export function emptyExternalBuffers() {
    return { bytes: new Map(), diagnostics: [] };
}
export function emptyExternalImages() {
    return { bytes: new Map(), diagnostics: [] };
}
//# sourceMappingURL=glb-uri-external-fetch.js.map