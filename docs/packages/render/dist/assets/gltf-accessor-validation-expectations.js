...
export function expectationForSemantic(semantic, accessor) {
    switch (semantic) {
        case "POSITION":
        case "NORMAL":
        ...
        case "MORPH_NORMAL_0":
        case "MORPH_NORMAL_1":
            return floatOrQuantizedNormalizedExpectation(accessor, "VEC3", "float32x3");
        case "TEXCOORD_0":
        case "TEXCOORD_1":
            return floatOrQuantizedNormalizedExpectation(accessor, "VEC2", "float32x2");
        case "TANGENT":
            return floatOrQuantizedNormalizedExpectation(accessor, "VEC4", "float32x4");
        case "COLOR_0":
...
export function hasUnsupportedQuantizedComponentType(semantic, accessor) {
...
function floatOrQuantizedNormalizedExpectation(accessor, type, expectedFormat) {
...
function quantizedAttributeType(semantic) {
    switch (semantic) {
        case "POSITION":
        case "NORMAL":
        case "MORPH_POSITION_0":
...
function isQuantizedNormalizedComponentType(value) {
    return (typeof value === "number" &&
        QUANTIZED_NORMALIZED_COMPONENT_TYPES.includes(value));
}
//# sourceMappingURL=gltf-accessor-validation-expectations.js.map