import { KTX2_HEADER_BYTE_LENGTH, KTX2_IDENTIFIER, KTX2_LEVEL_INDEX_BYTE_LENGTH, } from "./ktx2-constants.js";
import { bytesView, readUint64 } from "./ktx2-utils.js";
export function parseKtx2Container(source) {
    ...
    const levelIndexEnd = KTX2_HEADER_BYTE_LENGTH + levelCount * KTX2_LEVEL_INDEX_BYTE_LENGTH;
    if (bytes.byteLength < levelIndexEnd) {
        throw new Error("KTX2 data is too small to contain the level index.");
    }
    const levels = [];
    for (let level = 0; level < levelCount; level += 1) {
        const offset = KTX2_HEADER_BYTE_LENGTH + level * KTX2_LEVEL_INDEX_BYTE_LENGTH;
...
//# sourceMappingURL=ktx2-container.js.map