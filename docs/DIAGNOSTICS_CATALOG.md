...
| `aperture.headless.invalidCommand`       | The command dispatch requires a non-empty 'channel'.                                                                                                                 | —    | `packages/cli/src/headless/session-controller.ts`                                                  |
...
| Code                                        | Message                                                                                                                                                                                                                     | Fix? | Emitted from                                                                                       |
| ------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---- | -------------------------------------------------------------------------------------------------- |
| `aperture.render.blankFrame`                | The rendered frame is blank (a single flat color). This usually means the snapshot's source assets did not resolve, WebGPU produced no output, or the browser ran headless (which does not composite the WebGPU canvas into | —    | `packages/cli/src/commands/render.ts`                                                              |
