...
| `aperture.entityLookup.invalidComponentFieldValue`   | Field '…' on component '…' requires a string value.                            | yes  | `packages/app/src/entities/lookup/mutation.ts`                                               |
