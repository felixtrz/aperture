...
OBJ/FBX/USD/STL/…, no exporters), geometry primitive breadth (17 primitives vs
...
| Geometry & meshes       | 🟡       | Solid data model (morph/skin/multi-stream); 17 primitives vs 21+ incl. platonic solids (G1), no extrude/text/edges geometry                                     |
...
| Feature               | three.js                                                                                                                                                                   | Aperture                                                                                                                                                                                                   | Status |
| --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| Primitives            | 21: box, capsule, circle, cone, cylinder, dodeca/icosa/octa/tetrahedron, extrude, lathe, plane, polyhedron, ring, shape, sphere, torus, torus-knot, tube, edges, wireframe | 17: box, plane, sphere, cone, cylinder, capsule, torus, line-list, circle, ring, torus-knot, polyhedron, tetra/octa/icosa/dodecahedron, rounded-box (G1); no extrude/lathe/tube/shape/text/edges/wireframe | 🟡     |
...
3. **Animation depth** — N-clip mixing + additive layers (F1) and two-bone +
   ...
   or retargeting (§10).
4. **Geometry authoring** — 17 primitives incl. circle/ring/torus-knot,
   platonic solids via one polyhedron builder, and rounded box (G1); still no
   shape/extrude/lathe/tube/text geometry, no edges/wireframe derivation (§7).
