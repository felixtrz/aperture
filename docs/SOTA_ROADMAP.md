...
**Last updated:** `2026-05-29 08:55 PDT — codex/gpt-5`
...
**Next recommended task:** `M1-T9 — make all packages publishable`
...
**Gate status:** `pnpm run check = pass; spatial population Vitest = pass; auto-picking Playwright = pass`
...
| ----------- | ---- | ----------- | ---------- | -------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| [M1](#m1)   | 0    | in-progress | 8/11       | `auto-shadow` route + compressed-GLB load + picking + `npm publish --dry-run` ⬜ | M1 picking path complete through auto-populated BVH spatial index; publishing remains M1-T9 |
...
`clean — no in-flight work. M1-T8 is complete in 6d998669; M1 remains incomplete at 8/11. Continue with M1-T9 package publishing metadata and npm pack dry-run guards.`
