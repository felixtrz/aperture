...
**Last updated:** `2026-05-29 09:09 PDT — codex/gpt-5`
...
**Next recommended task:** `M1-T10 — make the CLI scaffolder emit installable semver deps`
...
**Gate status:** `pnpm run check = pass; publish dry-run = pass; publish readiness guard = pass`
...
| ----------- | ---- | ----------- | ---------- | -------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| [M1](#m1)   | 0    | in-progress | 9/11       | `auto-shadow` route + compressed-GLB load + picking + `npm publish --dry-run` ⬜ | Packages are publishable and pack-guarded; CLI scaffold semver remains M1-T10 |
...
`clean — no in-flight work. M1-T9 is complete in 9962f384; M1 remains incomplete at 9/11. Continue with M1-T10 CLI scaffolder semver dependency output.`
...
| `packages/cli/src/create/package-json.ts`                                     | defaultApertureDependencySpec (19-21) + packageJsonFile (23-54). CLI_VERSION literal '0.0.0' (line 4) still forces workspace:\* and generated project version 0.0.0 — M1-T10 must derive the real package version and emit ^semver + a real project version.                                                                                                                                                                                                                                                                                                                                     |
