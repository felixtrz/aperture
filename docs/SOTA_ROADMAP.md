...
**Last updated:** `2026-05-30 12:15 PDT — claude/opus`
...
**Next recommended task:** `M5-T3 — equirectangular HDR -> cubemap projection pass + auto-wire single-asset IBL (deps M5-T2 ✅ now met; roadmap sequencing says land T2 then T3). M5-T4 and M5-T6 are also ready (no deps). M5 in progress (2/6).`
...
| [M5](#m5)   | 1    | in-progress | 2/6        | DFG / irradiance / transmission correctness routes ⬜                            | T1 ✅ split-sum DFG (analytic Karis + validated GPU DFG-LUT; examples/ibl-brdf). T2 ✅ cosine irradiance-convolution compute pass for diffuse IBL (examples/ibl-irradiance: convolved softens + bleeds vs raw cube). Next: T3 equirect→cube.                                                 |
...
#### `M5-T2` · Real cosine irradiance-convolution compute pass for diffuse IBL — ✅ done (2026-05-30 · TBDHASH2)
