...
**Last updated:** `2026-05-29 00:14 PDT — codex/gpt-5`
...
**Next recommended task:** `M1-T6 — generate GPU mipmaps for material textures + upload KTX2 precomputed mip chains`
...
**Gate status:** `pnpm run check = pass; compressed glTF Playwright route = pass; focused app/WebGPU decoder Vitest = pass`
...
| ----------- | ---- | ----------- | ---------- | -------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| [M1](#m1)   | 0    | in-progress | 5/11       | `auto-shadow` route + compressed-GLB load + picking + `npm publish --dry-run` ⬜ | M1-T5 app decoder factory wiring complete; texture mip upload remains M1-T6 |
