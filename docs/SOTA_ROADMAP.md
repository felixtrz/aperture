...
**Last updated:** `2026-05-29 08:09 PDT — codex/gpt-5`
...
**Next recommended task:** `M1-T7 — implement CameraHandle.rayFromPointer with real unprojection`
...
**Gate status:** `pnpm run check = pass; focused mip/KTX2 Vitest = pass; KTX2 Playwright route = pass; standard glTF sampler browser proof = pass`
...
| ----------- | ---- | ----------- | ---------- | -------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| [M1](#m1)   | 0    | in-progress | 6/11       | `auto-shadow` route + compressed-GLB load + picking + `npm publish --dry-run` ⬜ | M1-T6 texture mip generation/upload complete; picking remains M1-T7/M1-T8 |
