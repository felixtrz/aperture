...
**Last updated:** `2026-05-30 08:18 PDT — claude/opus`
...
**Gate status:** `pnpm run check = pass; shadow e2e specs pass via scripts/webgpu-e2e.sh (SwiftShader + xvfb): csm-directional, auto-shadow, point, spot, multi-light, shadow-bias (acne + cascade-continuity + PCSS contact-hardening). M4-T1..T7 fully proven.`
