...
**Last updated:** `2026-05-29 09:19 PDT — codex/gpt-5`
...
**Next recommended task:** `M1-T11 — add CI + release pipeline gates`
...
**Gate status:** `pnpm run check = pass; test/cli/create.test.ts = pass; publish pack readiness guard = pass`
...
| ----------- | ---- | ----------- | ---------- | -------------------------------------------------------------------------------- | ------------------------------------------------------- |
| [M1](#m1)   | 0    | in-progress | 10/11      | `auto-shadow` route + compressed-GLB load + picking + `npm publish --dry-run` ⬜ | CLI scaffold semver complete; CI/release remains M1-T11 |
...
`clean — no in-flight work. M1-T10 is complete in 3bdb211d; M1 remains incomplete at 10/11. Continue with M1-T11 CI + release pipeline gates.`
...
| `scripts/check-package-publish-readiness.mjs`                                 | M1-T9 guard for package publish metadata, dist export paths, package LICENSE files, pack contents, and workspace dependency conversion. M1-T11 should run it from CI/release.                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `package.json`                                                                | Root workspace manifest (private, version 0.1.0, MIT, build/test/check scripts, publish:dry-run). Reference for adding release/CI scripts and where a changesets/publish pipeline plugs in.                                                                                                                                                                                                                                                                                                                                                                                                      |
