...
Next step: start `task-3108` from `agent/BACKLOG.md`, rendering
texture-backed StandardMaterial iridescence thickness factors so
`KHR_materials_iridescence.iridescenceThicknessTexture` can vary thin-film color
