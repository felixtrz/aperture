...
export const MeshRenderer = defineComponent(
  "aperture.render.meshRenderer",
  {
    meshId: { type: EcsType.String, default: "" },
    material0Id: { type: EcsType.String, default: "" },
    material1Id: { type: EcsType.String, default: "" },
    material2Id: { type: EcsType.String, default: "" },
    material3Id: { type: EcsType.String, default: "" },
  },
  "Renderer-independent mesh authoring component that stores asset handle ids only.",
);
