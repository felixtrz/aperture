...
async function checkChangesetConfig() {
  ...
  if (!ignored.includes("playground")) {
    fail(".changeset/config.json ignore must exclude playground.");
  }

  for (const name of ["@aperture-engine/workspace", "examples", "playground"]) {
