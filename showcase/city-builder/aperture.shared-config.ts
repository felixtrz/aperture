...
import { STARTING_CASH, STRUCTURES } from "./src/lib/city-data.ts";

interface CityBuilderConfigOptions {
  readonly mode: "browser" | "headless";
  readonly baseUrl: string;
  readonly canvas?: string;
}

export function createCityBuilderConfig(options: CityBuilderConfigOptions) {
