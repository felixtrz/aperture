// Track logic ported from the Kenney Starter Kit (CC0) racing layout — pure
// logic only (no rendering). Grid layout, piece placement math, decoration
// buckets, NPCs, the base64url map codec, spawn position, and track bounds.
