  ...
  return {
    ...
    expectedRenderState:
      usesAlphaMaskDoubleSided || usesAlphaMaskTexture || usesAlphaMaskBackface
        ...
        : null,
    samplePoint:
      usesBaseColorTransformSampling || usesBaseColorUv1Transform
