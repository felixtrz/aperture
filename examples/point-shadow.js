...
function createScene(aperture, app, targetCanvas) {
  ...
  const wallMesh = assets.meshes.add(
    aperture.createBoxMeshAsset({
      label: "PointShadowReceiverWall",
      width: 4.2,
      height: 2.6,
      depth: 0.06,
    }),
    { id: "point-shadow-wall" },
  );
